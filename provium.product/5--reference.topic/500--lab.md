...
Files pushed into the guest via [`vm:push_file`](~provium/reference/vm#vmpush-filehost-path-guest-path-opts) already track themselves — `depends_on_file` is for files the fixture reads on the host side.
