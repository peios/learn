...
type: concept
description: A thread is the basic unit of work; a process is the boundary around its threads, holding the memory, open resources, and identity they share.
related:
...
The thread does the work; the process is the shared space the work happens in.
A program that does one thing at a time is a process with a single thread. A
program that does several things at once is a process with several threads,
