...
This page names every command in the topic. The companion topic, [Transforming text](~peios/transforming-text/overview), covers the commands that *reshape* text — sorting, de-duplicating, substituting characters.
