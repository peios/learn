...
title: ls
type: reference
description: List the contents of a directory — the default listing, the Peios long format and its security-descriptor columns, and the sorting and formatting options.
related:
