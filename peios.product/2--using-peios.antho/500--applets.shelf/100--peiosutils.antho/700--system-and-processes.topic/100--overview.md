...
| Command | Purpose |
|---|---|
| [`whoami`](~peios/system-and-processes/whoami) | Print the name of the user a process is running as. |
| [`id`](~peios/system-and-processes/id) | Print the user and group identity of a process, or of a named user. |
