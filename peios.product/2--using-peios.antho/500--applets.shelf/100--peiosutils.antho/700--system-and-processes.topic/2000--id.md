...
The order follows GNU: `id -G` lists the real group first, then the effective group if it differs, then the rest; the `groups=` field of the default output leads with the effective group.
