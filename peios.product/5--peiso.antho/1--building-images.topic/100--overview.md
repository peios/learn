...
package** — `dev.peios.peios-experimental` today, discoverable through its
`peios-experimental` compatibility capability — whose version is the OS
version, whose dependency closure is the base system (kernel, initramfs,
