...
title: Impersonation
type: concept
description: How a thread temporarily acts as another principal — the two-token model, the canonical server flow, and just-in-time impersonation for modern runtimes.
related:
