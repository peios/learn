...
type: concept
description: The two gates that decide a server's effective impersonation level — the identity gate and the integrity ceiling — and the silent downgrade they produce.
related:
