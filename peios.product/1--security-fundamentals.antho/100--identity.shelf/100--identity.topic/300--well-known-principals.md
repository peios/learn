...
type: concept
description: The catalog of principals whose SIDs are fixed by the system — what each well-known SID means, how it behaves in an access check, and which ones to use.
related:
  - peios/identity/sids
