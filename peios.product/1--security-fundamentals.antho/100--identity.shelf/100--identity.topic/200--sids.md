...
title: SIDs
type: concept
description: A SID (Security Identifier) is the unique name for a principal — the string form you see in logs, the binary form on the wire, and the comparison rule.
related:
