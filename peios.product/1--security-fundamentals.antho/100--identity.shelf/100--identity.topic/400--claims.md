...
type: concept
description: Claims are typed key-value attributes on a token — user and device attributes from the directory that conditional ACEs evaluate during access checks.
related:
  - peios/identity/sids
