...
title: Inheritance
type: concept
description: A child's SD is computed once, at creation, from the parent's inheritable ACEs and the creator's defaults — the parent is never walked at access-check time.
related:
