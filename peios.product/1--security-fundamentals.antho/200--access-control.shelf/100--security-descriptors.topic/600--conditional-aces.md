...
type: concept
description: An ACE gated by an expression over token claims, resource attributes, and local context — the model, the expression language, and the three-valued logic.
related:
