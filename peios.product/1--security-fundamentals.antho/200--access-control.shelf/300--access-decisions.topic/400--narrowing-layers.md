...
type: concept
description: The three layers that can only remove access — the restricted-token pass, confinement, and central access policies — in pipeline order, and what bypasses each.
related:
