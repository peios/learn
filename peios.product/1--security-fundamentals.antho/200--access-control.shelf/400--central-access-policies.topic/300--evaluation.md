...
title: Evaluation
type: concept
description: CAAP runs at step 12 — each referenced policy looked up, each applicable rule's effective DACL intersected with the running grant, with no recursion.
related:
