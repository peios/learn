...
type: concept
description: A central access policy is defined once and applied to many objects — referenced by SID from the SACL, evaluated at access-check time, and only ever narrowing.
related:
