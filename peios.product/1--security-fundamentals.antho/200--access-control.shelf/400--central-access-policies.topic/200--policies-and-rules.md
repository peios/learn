...
type: concept
description: A policy is a versioned bundle of rules — each with an optional applies-to expression, an effective DACL and SACL, and staged versions for testing.
related:
