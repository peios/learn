...
type: concept
description: A rule's staged DACL and SACL are evaluated in parallel without affecting access — the staging mismatch flag shows where a proposed change would differ.
related:
