...
title: Auditing
type: concept
description: Auditing records what happened, separate from what was allowed. Audit ACEs, token audit policy, and delivery through KMES to userspace consumers.
related:
