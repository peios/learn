...
type: reference
description: The audit event schemas and the KMES transport that carries them — access-audit, continuous-audit, privilege-use, and logon-session-destroyed.
related:
...
- [Audit ACEs](~peios/auditing/audit-aces) — the SACL mechanisms behind access-audit and continuous-audit events.
