...
type: concept
description: Confinement fires at step 11 as an absolute intersection — the DACL re-walked against the confinement identity, with nothing restored afterwards.
related:
