...
title: Confinement
type: concept
description: Confinement is the Peios sandbox model — policy applied to an application from outside that narrows what its token can reach, past even what privileges bypass.
related:
