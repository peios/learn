...
type: concept
description: A capability SID placed in a token's normal groups grants access through the ordinary DACL walk — the canonical pattern for service access at scale.
related:
