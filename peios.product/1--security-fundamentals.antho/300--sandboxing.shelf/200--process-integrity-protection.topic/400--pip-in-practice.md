...
type: concept
description: PIP's practical edges — the impersonation asymmetry, peinit as lifecycle manager, MIC versus PIP, the threat-model ceiling, and the v0.20 limits.
related:
