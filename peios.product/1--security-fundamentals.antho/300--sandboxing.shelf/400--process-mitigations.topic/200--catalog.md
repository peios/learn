...
title: Catalog
type: reference
description: The eight active mitigations — LSV, WXP, TLP, CFIF, CFIB, PIE, SML, NO_CHILD — what each one gates, what it blocks, and when to enable it.
related:
