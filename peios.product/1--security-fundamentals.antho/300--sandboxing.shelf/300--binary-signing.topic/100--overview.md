...
type: concept
description: A signed binary carries an ML-DSA-65 signature the kernel verifies at exec to set its PIP level — signing only adds trust, never blocks execution.
related:
