---
title: ACE Types
description: Every ACE type and body layout — the single-SID, object, callback and resource-attribute families, the AceType constants, and the ACL revision rules.
---
...
## Allocated but unimplemented ACE types
