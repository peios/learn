...
| `Machine\System\Services\<name>\Provides` | Roles this service fills, which dependencies may name in place of the service. `REG_MULTI_SZ`. Read at boot and on reload. | §7.6 |
