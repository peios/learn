...
## The provider [*resolution.provider-is-highest-stratum]
...
## Ancestors [*resolution.provider-chosen-per-component]
...
## Independence from the caller [*resolution.independent-of-caller]
...
## Reaching the object [*resolution.non-directory-forwarded]
...
## Staging entries [*resolution.staged-names-hidden]
...
## Recursion [*resolution.reentrant-superblock-eloop]
