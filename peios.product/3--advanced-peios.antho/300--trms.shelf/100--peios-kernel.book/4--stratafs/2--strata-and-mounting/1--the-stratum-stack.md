...
## A stratum is a path [*strata.no-cached-resolution]
...
## The resolution context [*mount.resolution-context-pinned]
...
## What a stratum's filesystem must provide [*strata.mount-time-checks]
...
## Flags [*strata.stack-errors-are-einval]
...
### `create` [*strata.create-designates-creation-and-copy-up-destination]
...
### `am` [*strata.am-governs-mount-time-only]
