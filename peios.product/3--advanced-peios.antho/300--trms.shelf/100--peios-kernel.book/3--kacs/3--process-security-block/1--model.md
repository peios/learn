...
the process, and impersonation never touches it. [*psb.impersonation-untouched]
...
token pointer. [*psb.canonical-on-task-blob] A mirrored, non-authoritative reference is also kept in
...
process identity. [*psb.cred-mirror-same-psb]
...
and any credential-level mirror continues to refer to it. [*psb.cred-swap-preserves-psb]
