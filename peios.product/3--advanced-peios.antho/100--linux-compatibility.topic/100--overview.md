...
type: concept
description: Peios runs Linux software with little to no modification. The Linux identity APIs return values projected from KACS; the token stays authoritative.
related:
...
[StrataFS](~peios/disks-and-filesystems/stratafs/overview).
