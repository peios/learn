...
title: Linux relics
type: concept
description: Linux features that survive for compatibility but are superseded — each with the privilege it needs and the native replacement to use instead.
related:
