...
type: reference
description: "The command-line grammar, flag value forms, the global flags and their exclusion rules, output renderers, exit codes, and how a recipe is located."
related:
...
[Commands and targets](~pekit/running/commands-and-targets).
...
invocation of that command. See [Workspaces](~pekit/running/workspaces).
...
are covered on [Commands and targets](~pekit/running/commands-and-targets).
...
[workspace](~pekit/running/workspaces) even when some members' commands ignore
some of the flags.
...
- [Commands and targets](~pekit/running/commands-and-targets) — what each command does and selects.
- [Command-line reference](~pekit/reference/cli) — every flag, its value form, and the validation table.
- [Workspaces](~pekit/running/workspaces) — the workspace tail and its flag placement.
- [Sources](~pekit/recipes/sources) — what materialising a remote recipe's source involves.
