...
(see the Transition Causes section), peinit evaluates the restart
policy:
...
1. Sender authentication MUST be performed (see the Notify socket
   section in the Control Interface).
