...
callable only from kernel context. The primary consumers are KMES and kernel
subsystems that need to stamp events or policy decisions with KACS identity
information.
...
- The current context has no PSB.
