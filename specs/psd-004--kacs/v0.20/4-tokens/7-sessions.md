...
> [!INFORMATIVE]
> Kernel-side LogonSession invalidation (marking a LogonSession as dead so that new access checks against its tokens fail immediately) is a future enhancement. The mechanism would be a dead flag on the LogonSession object, checked during AccessCheck. This is not part of v0.20.
