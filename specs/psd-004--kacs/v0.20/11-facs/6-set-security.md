...
After merging, the resulting SD MUST still have a non-null owner. The group
SID MAY be null. If the merge would produce an SD without an owner, the call
fails.
...
## Mandatory resource attribute protection
