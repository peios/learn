...
|---|---|---|
| `process_guid` | UUID | 128-bit identifier for this process instance. UUIDv4 per RFC 4122, generated by the kernel at fork. Immutable for the lifetime of the process. NOT copied from the parent — every process receives a new GUID. Used by KMES for identity stamping and event correlation. |
