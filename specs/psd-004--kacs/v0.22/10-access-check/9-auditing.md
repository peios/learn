...
- **Subject** — the calling token's identity (user SID, group SIDs, integrity level, PIP identity) and `auth_id` (LogonSession LUID, for correlating events to LogonSessions).
