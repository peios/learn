...
(CaseFolding.txt, status S and C entries) -- a fixed one-to-one
codepoint mapping with no locale dependency. This provides practical
compatibility with Windows' RtlCompareUnicodeString behaviour.
