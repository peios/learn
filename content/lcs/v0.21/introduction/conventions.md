...
matching the KACS v0.20 specification:
...
direction, and number for each ioctl are listed in the Constants
appendix. The size is the total byte count of the ioctl's argument
struct as defined in the Struct Layouts appendix. The final 32-bit
...
algorithm is defined in the data model Keys section.
