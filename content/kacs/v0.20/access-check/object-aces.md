...
**Upward from denials.** When an object ACE denies access to an attribute, the denial propagates upward unconditionally. The property set and root node are marked as denied for those bits. Sibling nodes are unaffected.
