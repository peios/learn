...
> [!NOTE]
> This page is a reference for readers who want to understand the precise evaluation logic. For a conceptual overview, see [How AccessCheck Evaluates Every Access Decision](~access-control/how-accesscheck-works).
