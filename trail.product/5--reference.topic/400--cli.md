...
| `--cbpath <PATH>` | one path segment | Also publish [a cache-busting copy](~trail/building/the-cache-busting-copy) of the whole site under `PATH`, with every link inside it rewritten to stay there. |
