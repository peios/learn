...
- [Limits and abuse controls](~wispist/reference/limits) — the installation defaults these declarations may lower.
- [Documents and collections](~wispist/using-wispist/documents-and-collections) — what a declared collection contains.
- [Forbidden](~wispist/problems/forbidden) — what a denied operation returns.
