...
- [HTTP API reference](~wispist/reference/http-api) — the routes these methods call.
- [Problem Details](~wispist/problems/overview) — every `code` a `WispistError` can carry.
- [Live updates](~wispist/using-wispist/live-updates) — how `subscribe` behaves across disconnects and resets.
