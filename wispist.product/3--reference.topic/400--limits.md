...
- [wispist.json reference](~wispist/reference/wispist-json) — how a release lowers collection limits.
- [Quota exceeded](~wispist/problems/quota-exceeded), [Request too large](~wispist/problems/request-too-large), [Rate limited](~wispist/problems/rate-limited) — the problems these bounds produce.
