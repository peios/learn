...
- [Documents and collections](~wispist/using-wispist/documents-and-collections) — the envelope, revision, and conditional-mutation model behind `update`.
- [Live updates](~wispist/using-wispist/live-updates) — what `subscribe` does underneath: snapshot, cursor, Server-Sent Events, reconnect, reset.
- [wispist.json reference](~wispist/reference/wispist-json) — every declaration field, profile, and limit.
