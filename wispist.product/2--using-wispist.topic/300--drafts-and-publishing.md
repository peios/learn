...
For what a rejected Current-preview mutation looks like to code, read [Forbidden](~wispist/problems/forbidden).

For the declaration each release carries, read the [wispist.json reference](~wispist/reference/wispist-json).
